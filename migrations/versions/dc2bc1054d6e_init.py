...
Revision ID: dc2bc1054d6e
Revises: c40873936b92
Create Date: 2023-05-06 19:47:13.277060
...
revision = 'dc2bc1054d6e'
down_revision = 'c40873936b92'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('achievement_users', sa.Column('image_url', sa.String()))
