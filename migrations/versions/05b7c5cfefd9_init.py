...
Revision ID: 05b7c5cfefd9
Revises: 0202d7d49002
Create Date: 2023-05-06 20:34:12.682341
...
revision = '05b7c5cfefd9'
down_revision = '0202d7d49002'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_column('achievement_users', 'image_url')
