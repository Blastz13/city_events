...
Revision ID: d04aaf59cc55
Revises: 
Create Date: 2023-04-29 17:42:39.217017
...
def upgrade():
    ...
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False, db_index=True),
    sa.Column('description', sa.String(length=255), nullable=False),
    sa.Column('link', sa.String(length=255), nullable=True),
    sa.Column('date_start', sa.DateTime(), nullable=True),
    sa.Column('rating', sa.Integer(), nullable=False),
    sa.Column('limit_member', sa.Integer(), nullable=False),
    sa.Column('location', sa.String(length=127), nullable=False),
    sa.Column('longitude', sa.Float(), nullable=False),
    sa.Column('latitude', sa.Float(), nullable=False),
    sa.Column('geo', geoalchemy2.types.Geometry(geometry_type='POINT', from_text='ST_GeomFromEWKT', name='geometry'), nullable=False),
    ...
    op.create_table('event_organizators',
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('event_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], ),
...
def downgrade():
    ...
    op.drop_table('event_organizators')
    ...
    op.drop_table('users')
    op.drop_index('idx_events_geo', table_name='events', postgresql_using='gist')
