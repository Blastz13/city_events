...
Revision ID: 1c131451613f
Revises: 14f20c9ff3cb
Create Date: 2023-05-15 20:25:34.466690
...
revision = '1c131451613f'
down_revision = '14f20c9ff3cb'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.create_table('event_subscribers',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('event_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='event_subscribers_event_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='event_subscribers_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='event_subscribers_pkey')
    )
