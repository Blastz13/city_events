...
Revision ID: 0202d7d49002
Revises: dc2bc1054d6e
Create Date: 2023-05-06 19:50:40.566611
...
revision = '0202d7d49002'
down_revision = 'dc2bc1054d6e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('achievements', sa.Column('image_url', sa.String(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index('nyc_census_blocks_geom_idx', 'events', ['geo'], unique=False)
    op.drop_column('achievements', 'image_url')
    op.add_column('achievement_users', sa.Column('image_url', sa.VARCHAR(), autoincrement=False, nullable=True))
