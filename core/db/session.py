...
engines = {
    "writer": create_async_engine(config.WRITER_DB_URL, pool_recycle=3600, pool_size=100),
    "reader": create_async_engine(config.READER_DB_URL, pool_recycle=3600, pool_size=100),
}
